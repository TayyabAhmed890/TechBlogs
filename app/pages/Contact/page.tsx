...
const page = () => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className={`${Pop.className} text-balance text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl`}>TechBlogs</h2>
        <p className="mt-2 text-lg/8 text-gray-600">Lets Talk About Technology in Modern World Era.</p>
      </div>
